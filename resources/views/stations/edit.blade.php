<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Stations') }} > {{ $station->label }} > {{ __('Edit') }}
        </h2>
    </x-slot>
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form method="post" action="{{ route('stations.update', $station) }}" class="mt-6 space-y-6">
                            @csrf
                            @method('PATCH')
                            ...
                            <div>
                                ...
                                <x-text-input id="code" name="code" type="text" class="mt-1 block w-full"
                                              :value="old('code', $station->code)" autofocus autocomplete="code"></x-text-input>
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                              :value="old('name', $station->name)" autocomplete="name"></x-text-input>
                            ...
                            <div>
                                ...
                                <x-text-input id="city" name="city" type="text" class="mt-1 block w-full"
                                              :value="old('city', $station->city)" autocomplete="city"></x-text-input>
                            ...
                            <div>
                                ...
                                <x-text-input id="chart_color" name="chart_color" type="color" class="mt-1 block w-full"
                                              :value="old('chart_color', $station->chart_color)" autocomplete="chart_color"></x-text-input>
                            ...
                            <div>
                                ...
                                <x-timezone-select id="timezone" name="timezone" class="mt-1 block w-full"
                                                   :value="old('timezone', $station->timezone)"></x-timezone-select>
                            ...
                            <div>
                                ...
                                <x-text-input id="latitude" name="latitude" type="text" class="mt-1 block w-full"
                                              :value="old('latitude', $station->latitude)" autocomplete="latitude">
                                </x-text-input>
                            ...
                            <div>
                                ...
                                <x-text-input id="longitude" name="longitude" type="text" class="mt-1 block w-full"
                                              :value="old('longitude', $station->longitude)" autocomplete="longitude">
                                </x-text-input>
